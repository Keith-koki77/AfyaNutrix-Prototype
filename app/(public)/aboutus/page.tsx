...
const AboutUs = () => {
  const values = [
    ...
    },
    {
      ...
      title: "Local First",
      description: "We prioritize African food systems, cultures, and health contexts"
    },
    {
      icon: <Stethoscope className="w-8 h-8" />,
      title: "Professionalism",
      description: "We uphold the highest standards of ethical care and clinical practice"
    },
    {
    ...
    },
    {
      ...
      title: "Equity",
      description: "Every nutritionist, regardless of location, deserves modern tools"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-gradient-to-br from-[#003B2C] to-[#004d38] text-white py-24 px-4">
        ...
        <div className="relative max-w-6xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-200 max-w-4xl mx-auto leading-relaxed">
            A first-of-its-kind digital platform built specifically for African nutrition professionals. 
            We empower nutritionists to manage clients, deliver impactful care, and build thriving private practices.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              At our core, we're building the digital operating system for African nutrition care—connecting 
              science, culture, and technology into one comprehensive system.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="bg-white p-8 rounded-2xl shadow-lg border-l-4 border-[#9CCC65]">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                To be the most trusted and transformative platform powering nutrition care across Africa. 
                We imagine a future where every nutritionist, from urban clinics to rural programs, 
                can deliver expert-level care, informed by local data and delivered with digital excellence.
              </p>
            </div>
            <div className="bg-white p-8 rounded-2xl shadow-lg border-l-4 border-[#003B2C]">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                To enable African nutritionists to run secure, data-driven, and culturally relevant 
                nutrition practices—anywhere, anytime, and with anyone. Whether you're just starting 
                your career or managing nutrition programs, AfyaNutrix helps you do more with less chaos.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-[#003B2C] mb-6">What We're Building</h2>
            <p className="text-xl text-gray-600 mb-8">
              AfyaNutrix is not just another SaaS. It's a private digital clinic in your pocket.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feature, index) => (
              <div key={index} className="flex items-start gap-4 p-6 bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow border-l-3 border-[#9CCC65]">
                <div className="flex-shrink-0 p-2 bg-[#9CCC65] bg-opacity-20 rounded-lg">
                  <div className="text-[#003B2C]">
                    {feature.icon}
                  </div>
                </div>
          ...
          <div className="text-center mt-12">
            <p className="text-lg text-gray-600 italic">
              Everything is designed with data privacy, clinical professionalism, and African health realities at its core.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {values.map((value, index) => (
              <div key={index} className="bg-white bg-opacity-10 backdrop-blur-sm p-6 rounded-xl border border-white border-opacity-20 hover:bg-opacity-20 transition-all">
                <div className="text-[#9CCC65] mb-4">
                  {value.icon}
                </div>
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-[#003B2C] mb-6">Strategic Goals</h2>
            <p className="text-xl text-gray-600">Our roadmap to transforming African nutrition care</p>
          </div>
          <div className="space-y-6">
            {goals.map((goal, index) => (
              <div key={index} className="flex items-start gap-4 p-6 bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow">
      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-[#003B2C] mb-6">Impact We Aim to Create</h2>
            <p className="text-xl text-gray-600">Transforming lives across the nutrition care ecosystem</p>
          </div>
          <div className="grid md:grid-cols-2 gap-8">
            {impacts.map((impact, index) => (
              <div key={index} className="bg-white p-8 rounded-2xl shadow-lg border-t-4 border-[#9CCC65] hover:shadow-xl transition-shadow">
                <h3 className="text-2xl font-bold text-[#003B2C] mb-6">{impact.category}</h3>
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-[#9CCC65] to-[#7CB342]">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl font-bold text-[#003B2C] mb-6">Join the Movement</h2>
          <p className="text-xl text-[#003B2C] mb-8 leading-relaxed">
            African nutrition care deserves better tools, deeper respect, and culturally grounded systems. 
            AfyaNutrix is here to make that a reality—one nutritionist at a time.
          </p>
