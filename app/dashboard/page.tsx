...
import { Users, Calendar, ChefHat, TrendingUp, Clock, AlertCircle, Plus, MessageSquare, BarChart3 } from "lucide-react"
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Good morning, Amina! 👋</h1>
          ...
          <CardContent>
            <div className="space-y-3">
              <div className="flex items-start space-x-3 p-3 bg-orange-50 border border-orange-200 rounded-lg">
                ...
                <div>
                  <p className="text-sm font-medium text-orange-800">3 clients haven't logged meals</p>
              ...
              <div className="flex items-start space-x-3 p-3 bg-green-50 border border-green-200 rounded-lg">
                ...
                <div>
                  <p className="text-sm font-medium text-green-800">5 new client inquiries</p>
