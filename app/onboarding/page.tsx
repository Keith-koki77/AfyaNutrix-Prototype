    ...
    <div className="min-h-screen bg-gradient-to-br from-[#1B5E20] to-[#2E7D32] flex items-center justify-center p-4">
      <Card className="w-full max-w-2xl">
        <CardHeader className="text-center">
          ...
          <CardDescription>Let's set up your practice in just a few steps</CardDescription>
          <div className="mt-4">
        ...
        <CardContent>
          ...
          {currentStep === 1 && (
            <div className="space-y-6">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600">This helps us customize AfyaNutrix for your needs</p>
              </div>
                ...
                <div>
                  ...
                  <Select onValueChange={(value) => handleInputChange("practiceType", value)}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="small-clinic">Small Clinic (2-5 nutritionists)</SelectItem>
                      <SelectItem value="large-clinic">Large Clinic (6+ nutritionists)</SelectItem>
          ...
          {currentStep === 2 && (
            <div className="space-y-6">
              <div className="text-center mb-6">
                <h3 className="text-xl font-semibold text-gray-900">About your clients</h3>
                <p className="text-gray-600">Help us understand your client base</p>
              </div>

              <div className="space-y-4">
                <div>
                  <Label htmlFor="averageClients">How many clients do you see per month?</Label>
                  <Select onValueChange={(value) => handleInputChange("averageClients", value)}>
                    <SelectTrigger>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3 mt-2">
                    {["Adults", "Children", "Pregnant Women", "Athletes", "Elderly", "Chronic Disease Patients"].map(
                      (type) => (
                  ...
                  <div className="space-y-3 mt-2">
                    ...
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) =>
                          handleInputChange("notifications", { ...formData.notifications, whatsapp: checked })
                        }
                      />
          ...
          {currentStep === 4 && (
            <div className="space-y-6">
              <div className="text-center mb-6">
                <h3 className="text-xl font-semibold text-gray-900">Your goals with AfyaNutrix</h3>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <Label htmlFor="expectedOutcomes">What would success look like for you? (optional)</Label>
                  <textarea
                    id="expectedOutcomes"
