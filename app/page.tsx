...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-white">
              ...
              <div className="relative">
                ...
                <div className="relative w-[280px] sm:w-[320px] md:w-[360px] bg-gradient-to-br from-[#003B2C] to-[#003B2C]  rounded-3xl p-2 shadow-2xl border border-slate-700">
                  <div className="rounded-2xl overflow-hidden">
                    <Image
                      src="https://afyanutrix.infinityfreeapp.com/wp-content/uploads/2025/06/Untitled_design__2_-removebg-preview-1.png"
      ...
      <section
        id="features"
        className="py-24 px-4 bg-gradient-to-b from-slate-50 to-teal"
      >
