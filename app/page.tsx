         ...
         <div className="grid lg:grid-cols-2 gap-16 items-center">
           ...
           <div className="text-left max-w-2xl">
             ...
             <p className="text-lg text-slate-400 mb-6 leading-relaxed max-w-xl">
               Replace WhatsApp chaos and spreadsheet fatigue with a unified
               platform that handles client management, progress tracking, and
               automated workflows — all while maintaining DPA 2019 compliance.
             </p>
       ...
       <div className="container mx-auto max-w-7xl">
         ...
         <div className="text-center mb-20">
           ...
           <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
             Built specifically for African nutritionists, with local foods,
             cultural context, and compliance built-in from day one.
           </p>
         </div>
         ...
         <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
           ...
           <Card className="group relative bg-white border-0 shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden">
             ...
             <CardHeader className="relative p-8">
               ...
               <CardDescription className="text-slate-600 leading-relaxed">
                 ...
                 integration with intelligent follow-ups.
               </CardDescription>
             </CardHeader>
           </Card>
           ...
           <Card className="group relative bg-white border-0 shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden">
             ...
             <CardHeader className="relative p-8">
               ...
               <CardDescription className="text-slate-600 leading-relaxed">
                 Auto-calculate macros, micros, and RDA matching with
                 comprehensive visual reports and insights.
               </CardDescription>
             </CardHeader>
           </Card>
           ...
           <Card className="group relative bg-white border-0 shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden">
             ...
             <CardHeader className="relative p-8">
               ...
               <CardDescription className="text-slate-600 leading-relaxed">
                 Client photo logging, symptom tracking, and real-time feedback
           ...
           <Card className="group relative bg-white border-0 shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden">
             ...
             <CardHeader className="relative p-8">
               ...
               <CardDescription className="text-slate-600 leading-relaxed">
                 End-to-end encrypted communication platform replacing
                 non-compliant WhatsApp conversations.
               </CardDescription>
             </CardHeader>
           </Card>
         </div>
       ...
       <div className="container mx-auto max-w-6xl text-center relative z-10">
         ...
         <div className="max-w-3xl mx-auto mb-16">
           ...
           <p className="text-xl text-gray-300 leading-relaxed">
             Join the community of professionals transforming their practice
             with AfyaNutrix
           </p>
         </div>
         ...
         <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16 max-w-4xl mx-auto">
           <div className="text-center">
             <div className="text-3xl font-bold text-[#9CCC65]  mb-2">
               2,000+
             </div>
       ...
       <div className="container mx-auto max-w-screen-xl text-center relative z-10">
         ...
         <div className="max-w-3xl mx-auto mb-16">
           ...
           <p className="text-xl text-gray-600 leading-relaxed mb-8">
             Scalable solutions designed for nutrition professionals at every
       ...
       <div className="container mx-auto max-w-6xl text-center relative z-10">
         ...
         <div className="border-t border-white/10 pt-12">
           <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
             <div className="text-center">
               <div className="text-2xl font-bold text-[#9CCC65] mb-1">
                 14 Days
               </div>
           ...
           <p className="text-gray-400 text-sm">
             🔐 Your data is secure with bank-level encryption • 🇰🇪 Built for
             Kenyan nutritionists
           </p>
         </div>
       </div>
     </section>
       ...
       <div className="relative container mx-auto max-w-5xl">
         ...
         <div className="text-center mb-16">
           ...
           <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
             Frequently Asked
             <span className="block text-[#1B5E20] bg-clip-text">
               Questions
             </span>
           </h2>
           ...
           <div className="grid md:grid-cols-3 gap-6 mb-12">
             <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
               ...
               <p className="text-gray-600 leading-relaxed">
                 ...
                 access client data. We don't sell, share, or mine your clients'
             ...
             <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
               ...
               <p className="text-gray-600 leading-relaxed">
                 In secure, encrypted servers located in <strong>Africa</strong>
                 , fully compliant with Kenya's Data Protection Act (DPA 2019)
             ...
             <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
               ...
               <p className="text-gray-600 leading-relaxed">
                 ...
                 permanently delete any client's data in just 2 clicks, ensuring
                 complete GDPR and DPA compliance.
               </p>
             </div>
           </div>
         </div>
         ...
         <div className="space-y-4">
           {[
             ...
             },
             {
               ...
               question:
                 "Is this recognized by any nutrition body or university?",
               answer:
           ...
           <div className="grid lg:grid-cols-5 md:grid-cols-3 gap-12 lg:gap-16">
             ...
             <div className="lg:col-span-2 md:col-span-3">
               ...
               <p className="text-gray-300 leading-relaxed max-w-md mb-8">
                 Empowering African nutritionists with cutting-edge,
                 culturally-grounded practice management solutions that drive
             ...
             <div className="flex flex-col lg:flex-row justify-between items-center gap-6">
               ...
               <div className="flex items-center gap-4 text-sm">
                 ...
                 <div className="text-gray-400">
                   Trusted by 2,500+ nutritionists
                 </div>
               </div>
             </div>
           </div>
